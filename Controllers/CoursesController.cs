...
//these lines are "Injecting dependancy" they keeep the context of the object and make it adjustable without needing to change the objects core
        ...
        public async Task<IActionResult> Index()
         /* if (databaseTableExists){
            run query-var RecordsInTable = await _contexts.Courses.TolistAsync();
            return view(RecordsInTable)
        }
        return Problem("Entity Set 'SchoolManagementDbContext.Courses'is null. ");
        Problem("Entity Set 'SchoolManagementDbContext.Courses'is null. ");was added below manuallly!
        */
        {
